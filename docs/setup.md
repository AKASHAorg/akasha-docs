...
Before diving into creating simple app, let's learn more about [extensions](./extensions/index.md). Once you're ready, you can start by [building a super simple app](./extensions/extension-tutorials/create-an-app.md).
